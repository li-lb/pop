package com.cnki.filter;

import com.alibaba.fastjson.JSONObject;
import com.alibaba.fastjson.serializer.SerializerFeature;
import com.cnki.jwt.JwtToken;
...
public class JwtFilter extends BasicHttpAuthenticationFilter implements Filter {
    ...
    protected boolean executeLogin(ServletRequest request, ServletResponse response) throws Exception {
        ...
        try {
            ...
            reType.setMsg("没有访问权限，原因是:" + e.getMessage());
            reType.setCode(401);
            //SerializerFeature.WriteMapNullValue为了null属性也输出json的键值对
            Object o = JSONObject.toJSONString(reType, SerializerFeature.WriteMapNullValue);
